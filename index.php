...
<section class="services" id="services">
    ...
    <div class="drop">
        ...
        <form action="" method="POST">     
                <input type="text" name="id" placeholder="Enter hospital" style="border:1px solid black;width:350px"/><br>
                <div id="sub">
...
?>        
    <div class="box-container">
        ...
        <div class="box">
            ...
            <h3>Non ICU beds with oxygen supply</h3>
            <div class="a1"> 
        ...
        <div class="box">
            ...
            <?php echo $row['Locate Hospital'];
                ...
                echo "<a href=\"$output\">$link_text</a>";
            ?>
            </div> 
